...
public class SSLContextFactory {
     ...
     * @throws Exception
     */
    public SSLContext makeContext(InputStream clientCertFile, String clientCertPassword, String caCertString) throws Exception {
     ...
     * @throws Exception
     */
    private KeyStore loadPKCS12KeyStore(InputStream certificateFile, String clientCertPassword) throws Exception {
